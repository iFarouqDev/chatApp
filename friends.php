	...
	<main>
		<div class="container-fluid">
			...
			<div class="row layout">
				...
				<title>Friends | User's Username</title>
				<!-- SELECTED MENU DISPLAY -->
				<div class="subMenu">
					<div class="subMenuHeading position-relative">
						<nav class="navbar navbar-expand-lg">
							<div class="container-fluid">
								<a class="navbar-brand" href="friends.php" title="Friends">Friends</a>
								...
								<ul class="navbar-nav newChat d-flex ms-auto mb-3 mb-lg-0 z-3 position-absolute end-0 top-0" title="New Chat">
									...
									<ul class="dropdown-menu" id="new-friends">
										<a class="navbar-brand px-2" href="friends.php" title="Friends">New Chat</a>
					...
					<div class="subMenuBody" id="the-chat-list">
						...
						<ul class="navbar-nav mb-lg-0 friends-list">
							<li class="nav-item">
								<a class="nav-link" href="friends.php">
									<div class="card">
										<div class="row card-body">
